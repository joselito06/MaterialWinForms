...
namespace MaterialWinForms.Components.Buttons
{
    ...
    public class MaterialSimpleButton : MaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                g.DrawMaterialShadowSimples(buttonBounds, Elevation);
            }
            ...
            using var buttonPath = GraphicsSimplesExtensions.CreateRoundedRectanglePathSimples(buttonBounds, 20);
            var oldClip = g.Clip;
            ...
            if (_buttonType != ButtonType.Text)
            {
                ...
                g.FillRoundedRectangleSimples(brush, buttonBounds, 20);
            }
            ...
            if (_buttonType == ButtonType.Outlined)
            {
                ...
                g.DrawRoundedRectangleSimples(pen, buttonBounds, 20);
            }
